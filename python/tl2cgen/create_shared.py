...
def create_shared(
    ...
    *,
    ...
    .. code-block:: python
       ...
       tl2cgen.generate_c_code(dirpath="./my/model", params={}, verbose=True)
       tl2cgen.create_shared(toolchain="msvc", dirpath="./my/model", verbose=True)

    Later, the shared library can be referred to by its directory name:

    .. code-block:: python

       predictor = tl2cgen.Predictor(libpath="./my/model", verbose=True)
    ...
    .. code-block:: python
       ...
       predictor = tl2cgen.Predictor(libpath="./my/model/model.dll", verbose=True)
    """
