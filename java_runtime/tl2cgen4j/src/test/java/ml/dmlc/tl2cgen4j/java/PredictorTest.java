...
/**
 * Test cases for TL2cgen Predictor
 *
 * @author Hyunsu Cho
 */
public class PredictorTest {
  ...
  @Test
  public void testPredictorBasic() throws TL2cgenError {
  ...
  @Test
  public void testPredict() throws TL2cgenError, IOException {
    Predictor predictor = new Predictor(mushroomLibLocation, -1, true);
  ...
  @Test
  public void testPredictMargin() throws TL2cgenError, IOException {
    Predictor predictor = new Predictor(mushroomLibLocation, -1, true);
    List<DataPoint> dmat = DMatrixBuilder.LoadDatasetFromLibSVM(mushroomTestDataLocation);
  ...
  @Test
  public void testSerialization() throws TL2cgenError, IOException, ClassNotFoundException {
    Predictor predictor = new Predictor(mushroomLibLocation, -1, true);
